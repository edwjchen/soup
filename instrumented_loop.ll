...
define dso_local i32 @main() #0 {
  call void @inj_function_call(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i32 0, i32 0))
  %1 = call i64 @inj_init()
  %2 = alloca i32, align 4
  store i32 0, i32* %2, align 4
  %3 = call i32 @loop(i32 2, i32 3, i32 4)
  ret i32 %3
}

declare void @inj_function_call(i8*)

declare i64 @inj_init()
